...
const MonthlyDonation = () => {
  ...
  return (
    <Card className="border-2 border-masjid-green/30 dark:border-masjid-green/20 dark:bg-gray-800/90 transition-all duration-300 hover:shadow-lg dark:hover:shadow-masjid-green/5">
      ...
      <CardFooter>
        <Button onClick={handleSubscribe} className="w-full bg-masjid-green hover:bg-masjid-green/90 text-white dark:bg-masjid-green/90 dark:hover:bg-masjid-green transition-colors duration-200">
          Subscribe Monthly
        </Button>
      </CardFooter>
    </Card>
