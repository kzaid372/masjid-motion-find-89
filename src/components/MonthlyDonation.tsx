...
const MonthlyDonation = () => {
  ...
  return (
    <Card className="border-2 border-masjid-green/30 dark:border-masjid-green/20">
      <CardHeader className="bg-masjid-green/10 dark:bg-masjid-green/5">
      ...
      <CardContent className="pt-6">
        <div className="text-center mb-6">
          <p className="text-4xl font-bold text-masjid-green">$30<span className="text-sm font-normal text-gray-500 dark:text-gray-400">/month</span></p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Contribute regularly to support our operations</p>
        </div>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="monthly-donor" className="border rounded-lg p-3 bg-gray-50 dark:bg-gray-800/50 mb-4 border-gray-200 dark:border-gray-700">
