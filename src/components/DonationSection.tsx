...
import { CreditCard, Banknote, Wallet, QrCode, Copy, Bookmark, Heart } from 'lucide-react';
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <Card className="w-full md:w-64 text-center">
              <CardContent className="pt-6">
                <div className="mb-4 bg-masjid-green/10 p-4 rounded-full inline-flex">
                  <Heart className="h-8 w-8 text-masjid-green" />
                </div>
                <h3 className="text-xl font-bold mb-2">Regular Donors</h3>
                <p className="text-3xl font-bold text-masjid-green">247+</p>
              </CardContent>
            </Card>
            ...
            <Card className="w-full md:w-64 text-center">
              <CardContent className="pt-6">
                <div className="mb-4 bg-masjid-green/10 p-4 rounded-full inline-flex">
                  <Bookmark className="h-8 w-8 text-masjid-green" />
                </div>
                <h3 className="text-xl font-bold mb-2">Projects Funded</h3>
                <p className="text-3xl font-bold text-masjid-green">12</p>
              </CardContent>
            </Card>
          </div>
        </div>
